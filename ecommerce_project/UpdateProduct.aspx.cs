...
namespace ecommerce_project
{
    public partial class AdminProduct : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                // Chek whether admin is logged in or not
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            if (fu.HasFile)
            {
                ...
                con.Close();
                GridView1.EditIndex = -1;
                Response.Write("<script>alert('Product Uploded Successfully');</script>");
                ShowProduct();
                DropDownList1.SelectedValue = "Select Category";
            }
            else
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Delete top (1) from Product1 where ProductId= '" + productID.Text + "'", con1);
            cmd.ExecuteNonQuery();
            con1.Close();
